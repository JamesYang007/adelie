...
While FISTA (\Cref{alg:pgd:fista}) and the adaptive restarted version
(\Cref{alg:pgd:fista-adares}) also give the same convergence rate,
\Cref{fig:bench:pgd-newton}
