...
#ifndef ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_S_TP
#define ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_S_TP \
    template <class ValueType, class MmapPtrType, class IndexType>
#endif
#ifndef ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_S
#define ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_S \
    MatrixNaiveSNPCombineS<ValueType, MmapPtrType, IndexType>
#endif
...
>
class MatrixNaiveSNPCombineS: public MatrixNaiveBase<ValueType, IndexType>
{
public:
    ...
    using io_t = io::IOSNPCombineS<MmapPtrType>;
...
public:
    explicit MatrixNaiveSNPCombineS(
        const io_t& io,
        size_t n_threads
    );
