...
#ifndef ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_R_TP
#define ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_R_TP \
    template <class ValueType, class MmapPtrType, class IndexType>
#endif
#ifndef ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_R
#define ADELIE_CORE_MATRIX_NAIVE_SNP_COMBINE_R \
    MatrixNaiveSNPCombineR<ValueType, MmapPtrType, IndexType>
#endif
...
>
class MatrixNaiveSNPCombineR: public MatrixNaiveBase<ValueType, IndexType>
{
public:
    ...
    using io_t = io::IOSNPCombineR<MmapPtrType>;
...
public:
    explicit MatrixNaiveSNPCombineR(
        const io_t& io,
        size_t n_threads
    );
