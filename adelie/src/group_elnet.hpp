...
#include <adelie_core/optimization/grpelnet_pin_naive.hpp>

namespace py = pybind11;
namespace gg = adelie_core;
...
{
    return adelie_core::group_elnet_objective(
...
//    Eigen::Ref<adelie_core::util::vec_type<bool>>& is_active
//)
//{
//    using namespace adelie_core;
