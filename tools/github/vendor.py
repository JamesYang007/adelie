# See https://github.com/scikit-learn/scikit-learn/blob/main/build_tools/github/vendor.py
...
TARGET_FOLDER = op.join("adelie", ".libs")
DISTRIBUTOR_INIT = op.join("adelie", "_distributor_init.py")
...
def make_distributor_init_64_bits(
    ...
    This file is imported first when importing the adelie package
...
def main(wheel_dirname):
    ...
    # Create the "adelie/.libs" subfolder
